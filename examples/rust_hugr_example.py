...
def example_rust_backend_usage():
    ...
    try:
        ...
        print(f"[OK] Created Rust compiler with naming: {compiler.get_naming_convention()}")
        ...
        print(f"[ERROR] Rust backend error: {e}")
...
def example_frontend_comparison():
    ...
    try:
        ...
        print(f"External backend setup: {e}")
...
def example_performance_benefits():
    ...
    def larger_circuit() -> tuple[bool, bool, bool, bool]:
        ...
        # Measure all
        return tuple(measure(q) for q in qubits)
...
def main():
    ...
    if not RUST_HUGR_AVAILABLE:
        ...
        print("   cd python/pecos-rslib && cargo build --features hugr-support")
