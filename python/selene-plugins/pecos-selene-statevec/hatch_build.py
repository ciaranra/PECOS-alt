...
class PecosSeleneStatevecBuildHook(BuildHookInterface):
    ...
    def initialize(self, version: str, build_data: dict) -> None:
        ...
        cargo_package = "pecos-selene-statevec"
        ...
        dest_dir = root / "python" / "pecos_selene_statevec" / "_dist" / "lib"
        ...
        # Collect artifacts
        artifacts = []
        dist_dir = root / "python" / "pecos_selene_statevec" / "_dist"
