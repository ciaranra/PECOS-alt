...
"""Main PyPHIR intermediate representation module.

This module provides the core PyPHIR (Python PECOS High-level Intermediate Representation) functionality for quantum
...
class PyPHIR:
    ...
    def __init__(
        ...
        """Initialize the PyPHIR instance.
    ...
    @classmethod
    def handle_op(cls, o: dict | str | int, p: PyPHIR) -> TypeOp | str | list | int:
        """Handle different types of operations in PyPHIR.

        Args:
            o: Operation data (dict, string, or integer).
            p: PyPHIR instance for context.
    ...
    def from_phir(
        ...
        """Takes a PHIR dictionary and converts it into a PyPHIR object."""
        p = PyPHIR(
            metadata=dict(
                phir.get("metadata", {}),
            ),
