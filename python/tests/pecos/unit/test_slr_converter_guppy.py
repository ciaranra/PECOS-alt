...
def test_slr_converter_guppy_does_not_have_undefined_variables():
    ...
    for line in lines:
        ...
        if '=' in line and not line.startswith('#') and not line.startswith('@'):
            ...
            if ',' in left_side:
                # Multiple assignment like: a, b, c = ...
                vars_defined = [v.strip() for v in left_side.split(',')]
            else:
                vars_defined = [left_side]
...
def test_slr_converter_hugr_simple():
...
def test_slr_converter_steane_guppy_generation():
    ...
    if 'c_a' in guppy_code:
        assert c_a_declared, "c_a is used but not declared in generated Steane code"
...
def test_slr_converter_steane_hugr_compilation():
...
def test_slr_converter_guppy_has_main_function():
...
def test_slr_converter_guppy_imports():
