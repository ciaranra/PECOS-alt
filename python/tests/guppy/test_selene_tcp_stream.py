...
try:
    import selene_sim
    from selene_sim.result_handling import TCPStream, ResultStream
...
def test_result_stream_wrapper():
...
def test_selene_with_custom_stream():
...
def explore_selene_instance_internals():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"1. SeleneInstance attributes:")
