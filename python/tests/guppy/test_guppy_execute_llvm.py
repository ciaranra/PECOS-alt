...
def test_guppy_execute_llvm() -> None:
    ...
    try:
        ...
        pytest.skip("execute_llvm module not available - this is an optional dependency")
    ...
    try:
        ...
        raise AssertionError(f"guppylang not available: {e}") from e
    ...
    try:
        ...
        raise AssertionError(f"HUGR compilation failed: {e}") from e
    ...
    try:
        ...
        if "Unknown type" in str(e):
            print("[INFO] Known limitation - Rust backend doesn't support all types yet")
        raise
