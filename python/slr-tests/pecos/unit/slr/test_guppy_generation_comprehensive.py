...
from pecos.slr import Block, CReg, If, Main, QReg, Repeat, SlrConverter, Permute
...
def test_syndrome_extraction_pattern():
...
def test_nested_repeat_with_measurements():
...
def test_multi_pair_cx_pattern():
...
def test_mixed_classical_quantum_complex():
