...
def test_ir_handles_array_measurement_patterns():
    ...
    # Find unpacking line
    unpack_line = next((i for i, line in enumerate(lines) if "q_0, q_1, q_2 = q" in line), -1)
...
def test_ir_handles_mixed_measurements():
...
def test_ir_with_conditional_measurements():
...
def test_ir_avoids_subscript_after_consume():
