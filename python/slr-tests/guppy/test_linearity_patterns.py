...
class TestLinearityPatterns:
    ...
    def test_function_modifies_but_returns_qubits(self):
    ...
    def test_conditional_consumption(self):
        ...
        assert "if flag[0]:" in guppy_code
    ...
    def test_multiple_functions_passing_qubits(self):
    ...
    def test_partial_array_in_function(self):
    ...
    def test_empty_main_linearity(self):
    ...
    def test_nested_blocks_linearity(self):
...
class TestResourceManagement:
    ...
    def test_function_with_local_qubits(self):
        ...
        class UseAncilla(Block):
            def __init__(self, data, ancilla, result):
                super().__init__()
                self.data = data
    ...
    def test_all_paths_consume_resources(self):
