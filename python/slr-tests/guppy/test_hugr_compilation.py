...
class TestHugrCompilation:
    ...
    def test_basic_measurement_compiles(self):
    ...
    def test_partial_consumption_compiles(self):
    ...
    def test_individual_measurements_compile(self):
    ...
    def test_function_with_returns_compiles(self):
    ...
    def test_conditional_measurements_compile(self):
    ...
    def test_nested_blocks_compile(self):
    ...
    def test_multiple_qregs_compile(self):
    ...
    def test_empty_main_compiles(self):
    ...
    def test_gates_only_with_cleanup_compiles(self):
...
class TestHugrCompilationFailures:
    ...
    def test_function_not_returning_qubits_fails(self):
...
class TestQECPatternCompilation:
    ...
    def test_steane_code_syndrome_extraction(self):
    ...
    def test_repetition_code_round(self):
