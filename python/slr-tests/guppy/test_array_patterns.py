...
from pecos.slr import Block, CReg, Main, QReg, SlrConverter, Permute


class TestArrayUnpacking:
    """Test array unpacking patterns for measurements."""
    
    def test_unpack_for_selective_measurement(self):
    ...
    def test_no_unpack_for_full_measurement(self):
    ...
    def test_unpack_timing_for_first_measurement(self):
    ...
    def test_unique_unpacked_names(self):
...
class TestArraySwapPatterns:
    ...
    def test_manual_element_swap(self):
...
class TestMeasurementIntoArrays:
    ...
    def test_measure_into_preallocated_array(self):
    ...
    def test_measure_into_multiple_arrays(self):
    ...
    def test_partial_array_measurement(self):
...
class TestComplexArrayPatterns:
    ...
    def test_dynamic_sized_arrays(self):
