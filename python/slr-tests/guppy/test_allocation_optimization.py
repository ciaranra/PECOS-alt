...
def test_short_lived_ancilla_optimization():
...
def test_reused_ancilla_no_optimization():
...
def test_mixed_allocation_strategy():
...
def test_conditional_scope_prevents_optimization():
...
def test_loop_scope_prevents_optimization():
...
def test_never_used_qubits():
    """Test detection of never-used qubits."""
    prog = Main(
        used := QReg("used", 1),
        unused := QReg("unused", 2),
