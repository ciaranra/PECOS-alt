...
def test_ir_while_loop_with_quantum():
...
def test_ir_nested_while_loops():
...
def test_ir_while_error_in_qasm():
...
def test_ir_for_loop_placeholder():
...
def test_while_loop_quantum_resource_handling():
