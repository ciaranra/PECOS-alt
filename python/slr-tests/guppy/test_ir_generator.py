...
def test_ir_simple_measurement():
    ...
    assert ("q = array(quantum.qubit() for _ in range(2))" in code or 
            "q_0 = quantum.qubit()" in code)
...
def test_ir_full_array_measurement():
...
def test_ir_conditional_resources():
    ...
    assert "quantum.measure(q[1])" in code
    # Should generate valid code
    assert "result(" in code
    

def test_ir_variable_renaming():
