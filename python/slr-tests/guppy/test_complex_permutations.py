...
def test_permute_complex_pattern():
    ...
    prog = Main(
        ...
        # 0->2, 2->4, 4->0 (cycle 1)
        # 1->3, 3->5, 5->1 (cycle 2)
        Permute([a[0], a[1], a[2], a[3], a[4], a[5]], 
...
def test_permute_partial_registers():
...
def test_permute_error_mismatched_elements():
