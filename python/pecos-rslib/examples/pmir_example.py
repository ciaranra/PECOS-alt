...
def main():
    ...
    print("\n2. Converting HUGR to PMIR (MLIR text)...")
    ...
    print("\n" + "=" * 60)
    print("Summary:")
    print("- HUGR → PMIR (MLIR) generation: ✓ Working")
