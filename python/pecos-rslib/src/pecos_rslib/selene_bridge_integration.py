...
def build_selene_with_bridge(hugr_package, build_dir: Path, name: str = "pecos_program") -> Any:
...
def create_bridge_simulator():
    ...
    try:
        ...
        raise ImportError("PECOS Bridge plugin not available - install quantum-pecos with Selene support")
...
def configure_selene_for_pecos():
    ...
    try:
        ...
        logger.warning("Could not configure Selene for PECOS - Bridge plugin not available")
        return False
