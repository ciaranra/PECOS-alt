...
def test_byte_message_builder_basic():
...
def test_byte_message_bell_state():
...
def test_byte_message_parameterized_gates():
...
def test_byte_message_builder_reuse():
...
def test_byte_message_with_measurements():
