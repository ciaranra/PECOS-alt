...
use pecos_engines::{sparse_stab, state_vector, DepolarizingNoise};
...
fn main() -> Result<(), PecosError> {
    ...
    let qasm_prog = QasmProgram::from_string(r#"
        OPENQASM 2.0;
        include "qelib1.inc";
        qreg q[2];
        creg c[2];
    ...
    println!("   Bell state simulation: {} shots completed", results.len());
    ...
    let llvm_prog = LlvmProgram::from_string(r#"
