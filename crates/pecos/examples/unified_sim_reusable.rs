...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let qasm = QasmProgram::from_string(r#"
        OPENQASM 2.0;
        include "qelib1.inc";
        qreg q[2];
        creg c[2];
    ...
    let qasm2 = QasmProgram::from_string(r#"
        OPENQASM 2.0;
        include "qelib1.inc";
        qreg q[3];
        creg c[3];
    ...
    let qasm3 = QasmProgram::from_string(r#"
        OPENQASM 2.0;
        include "qelib1.inc";
        qreg q[1];
        creg c[1];
    ...
    println!("  Speedup: {:.2}x", direct_time.as_secs_f64() / reuse_time.as_secs_f64());
