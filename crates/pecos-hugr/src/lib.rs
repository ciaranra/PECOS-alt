/*!
HUGR (Hierarchical Unified Graph Representation) Support for PECOS

This crate provides HUGR functionality for PECOS quantum programs, including:
- HUGR to LLVM IR compilation
- HUGR utilities and transformations
...
```text
HUGR JSON/Bytes → [pecos-hugr] → LLVM IR String/File
```
