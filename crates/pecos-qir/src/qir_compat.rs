...
pub unsafe extern "C" fn __hugr__quantum__h(qubit: i16) {
    unsafe { runtime::__quantum__qis__h__body(i64::from(qubit)) };
}
...
pub unsafe extern "C" fn __hugr__quantum__x(qubit: i16) {
    unsafe { runtime::__quantum__qis__x__body(i64::from(qubit)) };
}
...
pub unsafe extern "C" fn __hugr__quantum__y(qubit: i16) {
    unsafe { runtime::__quantum__qis__y__body(i64::from(qubit)) };
}
...
pub unsafe extern "C" fn __hugr__quantum__z(qubit: i16) {
    unsafe { runtime::__quantum__qis__z__body(i64::from(qubit)) };
}
...
pub unsafe extern "C" fn __hugr__quantum__cnot(control: i16, target: i16) {
    unsafe { runtime::__quantum__qis__cx__body(i64::from(control), i64::from(target)) };
}
...
pub unsafe extern "C" fn __hugr__quantum__cy(control: i16, target: i16) {
    unsafe {
        runtime::__quantum__qis__y__body(i64::from(target));
        runtime::__quantum__qis__cx__body(i64::from(control), i64::from(target));
        runtime::__quantum__qis__y__body(i64::from(target));
    }
}
...
pub unsafe extern "C" fn __hugr__quantum__measure(qubit: i16) -> bool {
    ...
    let measurement =
        unsafe { runtime::__quantum__qis__m__body(i64::from(qubit), result_id as i64) };
