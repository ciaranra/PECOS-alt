// src/engines/noise.rs (fully updated for ByteMessage)
...
// Implementation for DepolarizingNoise
    ...
    impl DepolarizingNoiseBuilder {
        ...
        pub fn build(self) -> Box<dyn NoiseModel> {
            ...
            if self.probability == 0.0 {
                Box::new(super::pass_through::PassThroughNoise)
            } else {
...
// Implementation for PassThroughNoise
