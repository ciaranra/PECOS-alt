...
│ (User-friendly) │     │ (Rust-friendly) │     │  (In-memory)    │
└─────────────────┘     └─────────────────┘     └─────────────────┘
        ↑                       ↑                        ↑
   External API          Intermediate              Internal IR
   Stable, versioned     Natural for Rust          Can change freely
...
## PHIR-RON (Intermediate Format)

**Purpose**: Natural Rust serialization, more concise than JSON
