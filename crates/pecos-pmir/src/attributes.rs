/*!
Attributes and metadata system for PMIR
...
PMIR embraces an abstract approach to quantum error correction and other
...
Example:
```rust
use pecos_pmir::attributes::AttributeBuilder;
use pecos_pmir::pmir::AttributeValue;
...
/// Common attribute keys used throughout PMIR
///
...
pub struct AttributeBuilder {
    attrs: HashMap<String, crate::pmir::AttributeValue>,
}
...
impl AttributeBuilder {
    ...
    pub fn with_tag(mut self, tag: &str) -> Self {
        self.attrs.insert(
            ...
            crate::pmir::AttributeValue::String(tag.to_string()),
        );
        self
    }
    ...
    pub fn with_algorithm(mut self, algorithm: &str) -> Self {
        self.attrs.insert(
            ...
            crate::pmir::AttributeValue::String(algorithm.to_string()),
        );
        self
    }
    ...
    pub fn with_interface(mut self, inputs: Vec<String>, outputs: Vec<String>) -> Self {
        self.attrs.insert(
            ...
            crate::pmir::AttributeValue::Array(
                inputs
                    .into_iter()
                    .map(crate::pmir::AttributeValue::String)
                    .collect(),
            ),
        );
        self.attrs.insert(
    ...
    pub fn parallelizable(mut self) -> Self {
        self.attrs.insert(
            ...
            crate::pmir::AttributeValue::Bool(true),
        );
        self
    }
    ...
    #[must_use]
    pub fn with_attr(mut self, key: &str, value: crate::pmir::AttributeValue) -> Self {
    ...
    pub fn with_string(mut self, key: &str, value: &str) -> Self {
        self.attrs.insert(
            key.to_string(),
            crate::pmir::AttributeValue::String(value.to_string()),
        );
        self
    }
    ...
    pub fn with_int(mut self, key: &str, value: i64) -> Self {
        self.attrs
            .insert(key.to_string(), crate::pmir::AttributeValue::Int(value));
        self
    }
    ...
    pub fn with_bool(mut self, key: &str, value: bool) -> Self {
        self.attrs
            .insert(key.to_string(), crate::pmir::AttributeValue::Bool(value));
        self
    }
    ...
    pub fn with_float(mut self, key: &str, value: f64) -> Self {
        self.attrs
            .insert(key.to_string(), crate::pmir::AttributeValue::Float(value));
        self
    }

    /// Add an array attribute
    #[must_use]
    pub fn with_array(mut self, key: &str, values: Vec<crate::pmir::AttributeValue>) -> Self {
        self.attrs
            .insert(key.to_string(), crate::pmir::AttributeValue::Array(values));
        self
    }
    ...
    pub fn with_dict(
        mut self,
        key: &str,
        dict: HashMap<String, crate::pmir::AttributeValue>,
    ) -> Self {
        self.attrs
            .insert(key.to_string(), crate::pmir::AttributeValue::Dict(dict));
        self
    }

    /// Build the attribute map
    #[must_use]
    pub fn build(self) -> HashMap<String, crate::pmir::AttributeValue> {
        self.attrs
    }
}
...
pub mod helpers {
    ...
    #[must_use]
    pub fn has_tag(attrs: &HashMap<String, crate::pmir::AttributeValue>, tag: &str) -> bool {
        attrs
            .get(keys::SEMANTIC_TAG)
            .and_then(|v| match v {
                crate::pmir::AttributeValue::String(s) => Some(s.as_str()),
                _ => None,
            })
            .is_some_and(|s| s == tag)
    }
    ...
    #[must_use]
    pub fn get_algorithm(attrs: &HashMap<String, crate::pmir::AttributeValue>) -> Option<String> {
        attrs.get(keys::ALGORITHM).and_then(|v| match v {
            crate::pmir::AttributeValue::String(s) => Some(s.clone()),
            _ => None,
        })
    }
    ...
    #[must_use]
    pub fn is_parallelizable(attrs: &HashMap<String, crate::pmir::AttributeValue>) -> bool {
        attrs
            .get(keys::PARALLELIZABLE)
            .and_then(|v| match v {
                crate::pmir::AttributeValue::Bool(b) => Some(*b),
                _ => None,
            })
            .unwrap_or(false)
    }
    ...
    pub fn get_int_attr(
        ...
        attrs.get(key).and_then(|v| match v {
            crate::pmir::AttributeValue::Int(i) => Some(*i),
            _ => None,
        })
    }
    ...
    pub fn attrs_from_pairs(
        pairs: &[(&str, crate::pmir::AttributeValue)],
    ) -> HashMap<String, crate::pmir::AttributeValue> {
        pairs
            .iter()
...
#[must_use]
pub fn example_qft_box() -> HashMap<String, crate::pmir::AttributeValue> {
    AttributeBuilder::new()
        .with_tag(tags::QFT)
        .with_algorithm("quantum_fourier_transform")
        .with_interface(vec!["qubits[n]".to_string()], vec!["qubits[n]".to_string()])
        .parallelizable()
        .with_attr("reversible", crate::pmir::AttributeValue::Bool(true))
        .with_attr("circuit_depth", crate::pmir::AttributeValue::Int(100)) // O(n²)
        .build()
}

/// Example: Creating a custom boxed operation with flexible attributes
#[must_use]
pub fn example_custom_box() -> HashMap<String, crate::pmir::AttributeValue> {
    AttributeBuilder::new()
        ...
        .with_dict("protocol.parameters", {
            ...
            params.insert("rounds".to_string(), crate::pmir::AttributeValue::Int(10));
            params.insert(
                "threshold".to_string(),
                crate::pmir::AttributeValue::Float(0.95),
            );
            params
        })
        .build()
