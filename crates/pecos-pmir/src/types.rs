/*!
Type system shared by both PAST and PMIR

This module defines the complete type system used throughout PECOS PMIR, including:
...
/// Core type system used by both PAST and PMIR
