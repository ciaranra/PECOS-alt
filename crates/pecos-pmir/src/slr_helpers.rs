/*!
Helper functions for translating from SLR/qeclib patterns to PMIR
...
qeclib to PMIR. The functions mirror SLR's compositional patterns.
*/

use crate::ops::{Operation, QuantumOp, SSAValue};
use crate::pmir::{AttributeValue, Block, Instruction, Region};
