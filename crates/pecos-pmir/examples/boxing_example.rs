...
use pecos_pmir::{
    ...
    pmir::{Function, Instruction, Module, Region},
...
fn main() {
    ...
    let qft_signature = FunctionType {
        inputs: vec![Type::Array(
            Box::new(Type::Qubit),
            pecos_pmir::types::ArraySize::Fixed(4),
        )],
    ...
    qft_region.attributes = AttributeBuilder::new()
        ...
        .with_attr("num_qubits", pecos_pmir::pmir::AttributeValue::Int(4))
        .with_attr("circuit_depth", pecos_pmir::pmir::AttributeValue::Int(16))
        .parallelizable()
        .build();
    ...
    syndrome_region.attributes = AttributeBuilder::new()
        ...
        .with_attr(
            "measurement_order",
            pecos_pmir::pmir::AttributeValue::String("sequential".to_string()),
        )
        .build();
    ...
    magic_state_prep.attributes = AttributeBuilder::new()
        ...
        .with_attr(
            "state_type",
            pecos_pmir::pmir::AttributeValue::String("T".to_string()),
        )
        .with_attr(
            "fidelity_required",
            pecos_pmir::pmir::AttributeValue::Float(0.999),
        )
        .build();
    ...
    shor_region.attributes = AttributeBuilder::new()
        ...
        .with_attr("contains_qft", pecos_pmir::pmir::AttributeValue::Bool(true))
        .with_attr(
