...
use pecos_pmir::{
    ...
    pmir::{Block, BlockRef, Function, Instruction, Region, Terminator},
...
fn create_conditional_with_regions() -> Instruction {
    ...
    let cond_op = Operation::ControlFlow(ControlFlowOp::Branch(
        pecos_pmir::ops::BranchType::Conditional {
...
fn create_loop_with_regions() -> Instruction {
    let loop_op = Operation::ControlFlow(ControlFlowOp::Loop(pecos_pmir::ops::LoopType::While {
...
fn demonstrate_function_as_operation() {
    ...
    let func_op = Operation::ControlFlow(ControlFlowOp::Call(pecos_pmir::ops::FunctionCall {
