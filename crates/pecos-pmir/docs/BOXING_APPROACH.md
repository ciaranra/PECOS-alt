# Boxing and Protocol Composition in PMIR

This document explains how PMIR uses MLIR's native structure to achieve the boxing/protocol approach for quantum computing, similar to the assembly macro pattern used in PECOS's Python side (slr/ and qeclib/).
