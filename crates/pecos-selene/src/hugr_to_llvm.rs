...
use crate::hugr_013_support::{load_hugr_013_package, Package, Hugr};
...
impl HugrCompiler {
    ...
    fn compile_function(&mut self, hugr: &Hugr, func_node: Node, func_defn: &FuncDefn) -> Result<(), SeleneError> {
    ...
    fn compile_extension_op(&mut self, _hugr: &Hugr, _node: Node, ext_op: &ExtensionOp) -> Result<(), SeleneError> {
        ...
        match (extension_name.as_str(), op_name.as_str()) {
            ("tket.quantum", "QAlloc") => {
                ...
                self.qubit_vars.insert(format!("q{}", self.qubit_counter), qubit_var);
            ...
            ("tket.quantum", "Y") => {
                if self.qubit_counter > 0 {
                    let qubit_var = &self.qubit_vars[&format!("q{}", self.qubit_counter - 1)];
                    writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__y__body(i64 {})", qubit_var)?;
                }
            }
            ("tket.quantum", "Z") => {
                if self.qubit_counter > 0 {
                    let qubit_var = &self.qubit_vars[&format!("q{}", self.qubit_counter - 1)];
                    writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__z__body(i64 {})", qubit_var)?;
                }
            }
            ("tket.quantum", "S") => {
                if self.qubit_counter > 0 {
                    let qubit_var = &self.qubit_vars[&format!("q{}", self.qubit_counter - 1)];
                    writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__s__body(i64 {})", qubit_var)?;
                }
            }
            ("tket.quantum", "T") => {
                if self.qubit_counter > 0 {
                    let qubit_var = &self.qubit_vars[&format!("q{}", self.qubit_counter - 1)];
                    writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__t__body(i64 {})", qubit_var)?;
                }
            }
            ("tket.quantum", "MeasureFree") => {
                ...
                if self.qubit_counter > 0 {
                    ...
                    writeln!(&mut self.llvm_ir, "  {} = call i64 @__quantum__rt__result_allocate()", result_var)?;
                    writeln!(&mut self.llvm_ir, "  {} = call i32 @__quantum__qis__m__body(i64 {}, i64 {})", measure_var, qubit_var, result_var)?;
                    // Record output
                    writeln!(&mut self.llvm_ir, "  %result_ptr{} = inttoptr i64 {} to i8*", self.result_counter, result_var)?;
                    writeln!(&mut self.llvm_ir, "  call void @__quantum__rt__result_record_output(i8* %result_ptr{}, i8* null)", self.result_counter)?;
                    self.result_vars.insert(format!("r{}", self.result_counter), result_var);
            ...
            ("tket.quantum", "CNOT") => {
                ...
                if self.qubit_counter >= 2 {
                    ...
                    writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__cnot__body(i64 {}, i64 {})", control, target)?;
                }
            }
            _ => {
    ...
    fn generate_default_circuit(&mut self) -> Result<(), SeleneError> {
        ...
        writeln!(&mut self.llvm_ir, "  %q0 = call i64 @__quantum__rt__qubit_allocate()")
            .map_err(|e| SeleneError::HugrError(e.to_string()))?;
        writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__x__body(i64 %q0)")
            .map_err(|e| SeleneError::HugrError(e.to_string()))?;
        writeln!(&mut self.llvm_ir, "  %result0 = call i64 @__quantum__rt__result_allocate()")
            .map_err(|e| SeleneError::HugrError(e.to_string()))?;
        writeln!(&mut self.llvm_ir, "  %m0 = call i32 @__quantum__qis__m__body(i64 %q0, i64 %result0)")
            .map_err(|e| SeleneError::HugrError(e.to_string()))?;
        writeln!(&mut self.llvm_ir, "  %result_ptr0 = inttoptr i64 %result0 to i8*")
            .map_err(|e| SeleneError::HugrError(e.to_string()))?;
        writeln!(&mut self.llvm_ir, "  call void @__quantum__rt__result_record_output(i8* %result_ptr0, i8* null)")
            .map_err(|e| SeleneError::HugrError(e.to_string()))?;
    ...
    fn generate_llvm_ir(&mut self) -> Result<String, SeleneError> {
        ...
        writeln!(&mut full_ir, "declare i64 @__quantum__rt__result_allocate()")?;
        ...
        writeln!(&mut full_ir, "declare void @__quantum__qis__cnot__body(i64, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__cz__body(i64, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__cy__body(i64, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__ch__body(i64, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__ccx__body(i64, i64, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__rx__body(double, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__ry__body(double, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__rz__body(double, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__crz__body(double, i64, i64)")?;
        writeln!(&mut full_ir, "declare i32 @__quantum__qis__m__body(i64, i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__qis__reset__body(i64)")?;
        writeln!(&mut full_ir, "declare void @__quantum__rt__result_record_output(i8*, i8*)")?;
        writeln!(&mut full_ir)?;
        
        // Entry point function
        let entry_name = self.entry_point.as_deref().unwrap_or("main");
        writeln!(&mut full_ir, "define void @{}() #0 {{", entry_name)?;
        ...
        if self.llvm_ir.is_empty() {
            ...
            writeln!(&mut full_ir, "  %q0 = call i64 @__quantum__rt__qubit_allocate()")?;
            writeln!(&mut full_ir, "  %q1 = call i64 @__quantum__rt__qubit_allocate()")?;
            writeln!(&mut full_ir, "  call void @__quantum__qis__h__body(i64 %q0)")?;
            writeln!(&mut full_ir, "  call void @__quantum__qis__cnot__body(i64 %q0, i64 %q1)")?;
            writeln!(&mut full_ir, "  %result0 = call i64 @__quantum__rt__result_allocate()")?;
            writeln!(&mut full_ir, "  %m0 = call i32 @__quantum__qis__m__body(i64 %q0, i64 %result0)")?;
            writeln!(&mut full_ir, "  %result_ptr0 = inttoptr i64 %result0 to i8*")?;
            writeln!(&mut full_ir, "  call void @__quantum__rt__result_record_output(i8* %result_ptr0, i8* null)")?;
            writeln!(&mut full_ir, "  %result1 = call i64 @__quantum__rt__result_allocate()")?;
            writeln!(&mut full_ir, "  %m1 = call i32 @__quantum__qis__m__body(i64 %q1, i64 %result1)")?;
            writeln!(&mut full_ir, "  %result_ptr1 = inttoptr i64 %result1 to i8*")?;
            writeln!(&mut full_ir, "  call void @__quantum__rt__result_record_output(i8* %result_ptr1, i8* null)")?;
        } else {
...
pub fn compile_guppylang_json_to_llvm(json: &serde_json::Value) -> Result<String, SeleneError> {
    ...
    if let Some(modules) = json.get("modules").and_then(|m| m.as_array()) {
        if let Some(first_module) = modules.first() {
            if let Some(nodes) = first_module.get("nodes").and_then(|n| n.as_array()) {
                ...
                for node in nodes {
                    if let Some(op) = node.get("op").and_then(|o| o.as_str()) {
                        if op == "CFG" {
                            ...
                            return crate::hugr_to_llvm_cfg_support::compile_guppylang_json_with_cfg_support(json);
                        }
                    }
                }
            }
...
pub struct GuppylangCompiler {
    ...
    operations: Vec<(String, Vec<String>)>, // (operation, arguments)
...
impl GuppylangCompiler {
    ...
    pub fn compile_hugr_json(&mut self, hugr_bytes: &[u8]) -> Result<String, SeleneError> {
        ...
        let json_value: serde_json::Value = if hugr_bytes.len() >= 10 && &hugr_bytes[0..8] == b"HUGRiHJv" {
            ...
            return Err(SeleneError::HugrError(
                format!("HUGR envelope format {} not supported", format_byte)
            ));
        } else {
        ...
        // Get modules array
        let modules = json_value.get("modules")
            .and_then(|m| m.as_array())
    ...
    fn generate_llvm_preamble(&mut self) -> Result<(), SeleneError> {
        // Module header
        writeln!(&mut self.llvm_ir, "; ModuleID = 'guppylang_module'")?;
        writeln!(&mut self.llvm_ir, "source_filename = \"guppylang.ll\"")?;
        writeln!(&mut self.llvm_ir)?;
        
        // Quantum runtime declarations
        writeln!(&mut self.llvm_ir, "; Quantum runtime declarations")?;
        writeln!(&mut self.llvm_ir, "declare i64 @__quantum__rt__qubit_allocate()")?;
        writeln!(&mut self.llvm_ir, "declare i64 @__quantum__rt__result_allocate()")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__h__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__x__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__y__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__z__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__s__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__t__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__sdg__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__tdg__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__cnot__body(i64, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__cz__body(i64, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__cy__body(i64, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__ch__body(i64, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__ccx__body(i64, i64, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__rx__body(double, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__ry__body(double, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__rz__body(double, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__crz__body(double, i64, i64)")?;
        writeln!(&mut self.llvm_ir, "declare i32 @__quantum__qis__m__body(i64, i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__qis__reset__body(i64)")?;
        writeln!(&mut self.llvm_ir, "declare void @__quantum__rt__result_record_output(i8*, i8*)")?;
        
        Ok(())
    }
    
    fn process_nodes(&mut self, nodes: &[serde_json::Value], edges: &[serde_json::Value]) -> Result<(), SeleneError> {
                ...
                if edge_array.len() >= 2 {
                    if let (Some(src_arr), Some(tgt_arr)) = (
                        ...
                        if let (Some(src_node), Some(tgt_node)) = (
                            ...
                            edge_map.entry(src_node as usize).or_insert_with(Vec::new).push(tgt_node as usize);
                            reverse_edge_map.entry(tgt_node as usize).or_insert_with(Vec::new).push(src_node as usize);
                        }
                    }
                }
            }
        ...
        for (node_id, node) in nodes.iter().enumerate() {
            if let Some(op_str) = node.get("op").and_then(|o| o.as_str()) {
                if op_str == "Extension" {
                    ...
                    log::info!("Processing extension op: {}::{} at node {}", extension, name, node_id);
                    ...
                    match (extension, name) {
                        ("tket.quantum", "QAlloc") => {
                            ...
                            if let Some(qubit_var) = self.qubit_dataflow.get(&node_id) {
                                ...
                                log::debug!("QAlloc: Allocated {} at node {} from dataflow", qubit_var, node_id);
                            } else {
                                ...
                                self.qubit_counter += 1;
                                log::debug!("QAlloc: Allocated {} at node {} (fallback, counter={})", qubit_var, node_id, self.qubit_counter);
                            }
                        }
                        ("tket.quantum", "H") => {
                        ...
                        ("tket.quantum", "Sdg") => {
                            if let Some(qubit_var) = self.find_input_qubit(node_id, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__sdg__body(i64 {})", qubit_var)?;
                            }
                        }
                        ("tket.quantum", "Tdg") => {
                            if let Some(qubit_var) = self.find_input_qubit(node_id, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__tdg__body(i64 {})", qubit_var)?;
                            }
                        }
                        ("tket.quantum", "CH") => {
                            if let Some((control_var, target_var)) = self.find_two_input_qubits_with_ports(node_id, edges, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__ch__body(i64 {}, i64 {})", control_var, target_var)?;
                            }
                        }
                        ("tket.quantum", "CCX") | ("tket.quantum", "Toffoli") => {
                            // Toffoli needs 3 qubits
                            if let Some((control1, control2, target)) = self.find_three_input_qubits_with_ports(node_id, edges, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__ccx__body(i64 {}, i64 {}, i64 {})", control1, control2, target)?;
                            }
                        }
                        ("tket.quantum", "Reset") => {
                            if let Some(qubit_var) = self.find_input_qubit(node_id, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__reset__body(i64 {})", qubit_var)?;
                            }
                        }
                        ("tket.quantum", "CZ") => {
                            if let Some((control_var, target_var)) = self.find_two_input_qubits_with_ports(node_id, edges, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__cz__body(i64 {}, i64 {})", control_var, target_var)?;
                            }
                        }
                        ("tket.quantum", "CY") => {
                            if let Some((control_var, target_var)) = self.find_two_input_qubits_with_ports(node_id, edges, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__cy__body(i64 {}, i64 {})", control_var, target_var)?;
                            }
                        }
                        ("tket.quantum", "Rx") => {
                            if let Some(qubit_var) = self.find_input_qubit(node_id, &edge_map, nodes) {
                                ...
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__rx__body(double {}, i64 {})", angle, qubit_var)?;
                            }
                        }
                        ("tket.quantum", "Ry") => {
                            if let Some(qubit_var) = self.find_input_qubit(node_id, &edge_map, nodes) {
                                let angle = self.find_rotation_angle(node_id, &edge_map, nodes)?;
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__ry__body(double {}, i64 {})", angle, qubit_var)?;
                            }
                        }
                        ("tket.quantum", "Rz") => {
                            if let Some(qubit_var) = self.find_input_qubit(node_id, &edge_map, nodes) {
                                let angle = self.find_rotation_angle(node_id, &edge_map, nodes)?;
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__rz__body(double {}, i64 {})", angle, qubit_var)?;
                            }
                        }
                        ("tket.quantum", "CRz") => {
                            if let Some((control_var, target_var)) = self.find_two_input_qubits_with_ports(node_id, edges, &edge_map, nodes) {
                                let angle = self.find_rotation_angle(node_id, &edge_map, nodes)?;
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__crz__body(double {}, i64 {}, i64 {})", angle, control_var, target_var)?;
                            }
                        }
                        ("tket.quantum", "CX") | ("tket.quantum", "CNOT") => {
                            // CNOT requires two qubits - need to find both inputs
                            log::debug!("Processing CX/CNOT at node {}", node_id);
                            if let Some((control_var, target_var)) = self.find_two_input_qubits_with_ports(node_id, edges, &edge_map, nodes) {
                                writeln!(&mut self.llvm_ir, "  call void @__quantum__qis__cnot__body(i64 {}, i64 {})", control_var, target_var)?;
                                log::debug!("Generated CNOT with control {} and target {}", control_var, target_var);
                            } else {
                                log::warn!("Could not find input qubits for CX/CNOT gate at node {}", node_id);
                            }
                        }
                        ("tket.quantum", "MeasureFree") => {
                            ...
                            if let Some(qubit_var) = self.qubit_dataflow.get(&node_id) {
                                log::debug!("Found MeasureFree node {} with qubit {}", node_id, qubit_var);
                                let result_var = format!("%result{}", self.result_counter);
                                let measure_var = format!("%m{}", self.result_counter);
                                writeln!(&mut self.llvm_ir, "  {} = call i64 @__quantum__rt__result_allocate()", result_var)?;
                                writeln!(&mut self.llvm_ir, "  {} = call i32 @__quantum__qis__m__body(i64 {}, i64 {})", measure_var, qubit_var, result_var)?;
                                ...
                                log::debug!("MeasureFree node {} not in dataflow map, looking through edges", node_id);
                                        ...
                                        if edge_array.len() >= 2 {
                                            if let (Some(src_arr), Some(tgt_arr)) = (
                                                ...
                                                if let Some(tgt_node) = tgt_arr.get(0).and_then(|n| n.as_u64()) {
                                                    if tgt_node as usize == node_id {
                                                        // This edge targets our MeasureFree node
                                                        if let Some(tgt_port) = tgt_arr.get(1).and_then(|p| p.as_u64()) {
                                                            // Port 0 is the qubit input, other ports are for chaining
                                                            if tgt_port == 0 {
                                                                if let Some(src_node) = src_arr.get(0).and_then(|n| n.as_u64()) {
                                                                    log::debug!("MeasureFree node {} has qubit input from node {}", node_id, src_node);
                                                                    
                                                                    // Check if the source node is a measurement (to skip it)
                                                                    if let Some(src_node_info) = nodes.get(src_node as usize) {
                                                                        if let Some(src_name) = src_node_info.get("name").and_then(|n| n.as_str()) {
                                                                            if src_name == "MeasureFree" {
                                                                    ...
                                                                    if let Some(qubit) = self.find_input_qubit(src_node as usize, &edge_map, nodes) {
                                                                        log::debug!("Found qubit {} for MeasureFree node {}", qubit, node_id);
                        ...
                        ("tket.quantum", "QFree") | ("tket.quantum", "Discard") => {
    ...
    fn find_input_qubit(&self, node_id: usize, edge_map: &HashMap<usize, Vec<usize>>, nodes: &[serde_json::Value]) -> Option<String> {
        ...
        if let Some(qubit_var) = self.qubit_dataflow.get(&node_id) {
            log::debug!("Found qubit {} for node {} in dataflow map", qubit_var, node_id);
        ...
        if let Some(qubit_var) = self.qubit_vars.get(&node_id) {
            log::debug!("Node {} is a QAlloc with qubit {}", node_id, qubit_var);
            return Some(qubit_var.clone());
        }
        ...
        for (src_id, targets) in edge_map {
            if targets.contains(&node_id) {
                log::debug!("  Node {} has input from node {}", node_id, src_id);
                
                // Check dataflow for the source node
                if let Some(qubit_var) = self.qubit_dataflow.get(src_id) {
                    log::debug!("  Found qubit {} for source node {} in dataflow", qubit_var, src_id);
                    return Some(qubit_var.clone());
                }
                
                // Check if source is a qubit allocation
                if let Some(qubit_var) = self.qubit_vars.get(src_id) {
                    log::debug!("  Found qubit var {} for node {} in qubit_vars", qubit_var, src_id);
                    return Some(qubit_var.clone());
                }
            }
        }
        
        log::warn!("Could not find qubit for node {} via dataflow", node_id);
        None
    }
    
    fn find_rotation_angle(&self, node_id: usize, edge_map: &HashMap<usize, Vec<usize>>, nodes: &[serde_json::Value]) -> Result<String, SeleneError> {
        ...
        Err(SeleneError::HugrError("Could not find rotation angle".to_string()))
    }
    
    fn find_halfturns_value(&self, from_halfturns_node_id: usize, edge_map: &HashMap<usize, Vec<usize>>, nodes: &[serde_json::Value]) -> Result<String, SeleneError> {
            ...
            for &target in targets {
                if target == from_halfturns_node_id {
                    ...
                    if let Some(const_node) = nodes.get(*src_id) {
                        if let Some(op) = const_node.get("op").and_then(|o| o.as_str()) {
                            if op == "Const" || op == "LoadConstant" {
                                // Extract the float value
                                if let Some(v) = const_node.get("v") {
                                    if let Some(half_turns) = self.extract_float_from_const_value(v) {
                                        // Convert from half-turns to radians: radians = half_turns * π
                                        let radians = half_turns * std::f64::consts::PI;
                                        log::info!("Found rotation angle: {} half-turns = {} radians", half_turns, radians);
                                        return Ok(format!("{:.16}", radians));
                                    }
                                }
        ...
        if let Some(vs) = value.get("vs").and_then(|v| v.as_array()) {
            if let Some(first) = vs.first() {
                if let Some(val) = first.get("value") {
                    if let Some(c) = val.get("c").and_then(|c| c.as_str()) {
                        if c == "ConstF64" {
                            if let Some(v) = val.get("v") {
                                if let Some(float_val) = v.get("value").and_then(|v| v.as_f64()) {
    ...
    fn extract_angle_from_node(&self, node: &serde_json::Value) -> Result<String, SeleneError> {
        log::debug!("Extracting angle from node: {}", serde_json::to_string_pretty(node).unwrap_or_default());
        ...
        if let Some(args) = node.get("args").and_then(|a| a.as_array()) {
            ...
            for (i, arg) in args.iter().enumerate() {
                log::debug!("Checking arg[{}]: {}", i, serde_json::to_string(arg).unwrap_or_default());
    ...
    fn find_three_input_qubits(&self, node_id: usize, edge_map: &HashMap<usize, Vec<usize>>, nodes: &[serde_json::Value]) -> Option<(String, String, String)> {
        // Find which nodes output to this node (should be 3 for Toffoli)
        let mut input_qubits = Vec::new();
        
        for (src_id, targets) in edge_map {
            if targets.contains(&node_id) {
                // Check if source is a qubit or quantum op
                if let Some(qubit_var) = self.qubit_vars.get(src_id) {
                    input_qubits.push(qubit_var.clone());
                } else if let Some(op_str) = nodes.get(*src_id).and_then(|n| n.get("op")).and_then(|o| o.as_str()) {
                    if op_str == "Extension" {
                        // This is another quantum op, find its input
                        if let Some(qubit) = self.find_input_qubit(*src_id, edge_map, nodes) {
                            input_qubits.push(qubit);
                        }
                    }
                }
            }
        ...
        // Toffoli expects exactly 3 inputs
        if input_qubits.len() >= 3 {
            Some((input_qubits[0].clone(), input_qubits[1].clone(), input_qubits[2].clone()))
        } else if self.qubit_counter >= 3 {
            // Fallback to the three most recent qubits
            Some((
                format!("%q{}", self.qubit_counter - 3),
                format!("%q{}", self.qubit_counter - 2),
                format!("%q{}", self.qubit_counter - 1)
            ))
        } else {
            None
        }
    ...
    fn find_two_input_qubits_with_ports(&self, node_id: usize, edges: &[serde_json::Value], _edge_map: &HashMap<usize, Vec<usize>>, _nodes: &[serde_json::Value]) -> Option<(String, String)> {
        ...
        eprintln!("DEBUG: Current unpack_tuple_outputs: {:?}", self.unpack_tuple_outputs);
                    ...
                    if let (Some(src_arr), Some(tgt_arr)) = (
                        ...
                        if let Some(tgt_node) = tgt_arr.get(0).and_then(|n| n.as_u64()) {
                            if tgt_node as usize == node_id {
                                ...
                                if let Some(src_node) = src_arr.get(0).and_then(|n| n.as_u64()) {
                                    let src_port = src_arr.get(1).and_then(|p| p.as_u64()).unwrap_or(0);
                                    let tgt_port = tgt_arr.get(1).and_then(|p| p.as_u64()).unwrap_or(0);
                                    
                                    log::debug!("  Edge {}: src_node={}, src_port={}, tgt_port={}", edge_idx, src_node, src_port, tgt_port);
                                    eprintln!("DEBUG:   Edge {}: src_node={}, src_port={}, tgt_port={}", edge_idx, src_node, src_port, tgt_port);
                                    ...
                                    if let Some(unpack_qubits) = self.unpack_tuple_outputs.get(&src_idx) {
                                        log::debug!("    Node {} is UnpackTuple with {} qubits: {:?}", src_node, unpack_qubits.len(), unpack_qubits);
                                        eprintln!("DEBUG:     Node {} is UnpackTuple with {} qubits: {:?}", src_node, unpack_qubits.len(), unpack_qubits);
                                        
                                        // Find the qubit for the specific source port
                                        if let Some((_, qubit)) = unpack_qubits.iter().find(|(port, _)| *port == src_port) {
                                            log::debug!("    Found qubit {} for UnpackTuple port {}", qubit, src_port);
                                            eprintln!("DEBUG:     Found qubit {} from UnpackTuple node {} port {}", qubit, src_node, src_port);
                                        ...
                                        eprintln!("DEBUG:     Found qubit {} from node {} (port {})", qubit, src_node, src_port);
                                        input_qubits.push((tgt_port, qubit.clone()));
                                    } else {
        ...
        if input_qubits.len() >= 2 {
            ...
            log::warn!("  Only found {} qubits, need 2 for CX gate", input_qubits.len());
            eprintln!("DEBUG:   Only found {} qubits, need 2 for CX gate", input_qubits.len());
            None
        }
    }
    
    fn find_three_input_qubits_with_ports(&self, node_id: usize, edges: &[serde_json::Value], _edge_map: &HashMap<usize, Vec<usize>>, _nodes: &[serde_json::Value]) -> Option<(String, String, String)> {
                                    ...
                                    if let Some(unpack_outputs) = self.unpack_tuple_outputs.get(&src_idx) {
                                        ...
                                        for (port, qubit_var) in unpack_outputs {
                                            if *port == src_port {
                                                ...
                                                log::debug!("Found qubit {} from UnpackTuple node {} port {}", 
                                                    qubit_var, src_idx, src_port);
                                                found = true;
                                                break;
                                            }
                                        }
                                        if !found {
                                            log::debug!("UnpackTuple node {} doesn't have output at port {}", src_idx, src_port);
                                        }
                                    } else if let Some(qubit) = self.qubit_dataflow.get(&src_idx) {
                                        // Not an UnpackTuple, use regular dataflow lookup
                                        input_qubits.push((tgt_port, qubit.clone()));
                                        log::debug!("Found qubit {} from node {} (port {})", qubit, src_idx, src_port);
                                    } else {
        ...
        if input_qubits.len() >= 3 {
            Some((input_qubits[0].1.clone(), input_qubits[1].1.clone(), input_qubits[2].1.clone()))
        } else {
            None
        }
    }
    
    fn find_two_input_qubits(&self, node_id: usize, edge_map: &HashMap<usize, Vec<usize>>, nodes: &[serde_json::Value]) -> Option<(String, String)> {
        log::debug!("find_two_input_qubits called for node {}", node_id);
        // Find which nodes output to this node (should be 2 for CNOT)
        let mut input_qubits = Vec::new();
        ...
        for (src_id, targets) in edge_map {
            if targets.contains(&node_id) {
                ...
                // Check if source is a qubit or quantum op
                if let Some(qubit_var) = self.qubit_vars.get(src_id) {
                    log::debug!("  Found direct qubit {} from node {}", qubit_var, src_id);
                    input_qubits.push(qubit_var.clone());
                } else if let Some(op_str) = nodes.get(*src_id).and_then(|n| n.get("op")).and_then(|o| o.as_str()) {
                    if op_str == "Extension" {
                        // This is another quantum op, find its input
                        if let Some(qubit) = self.find_input_qubit(*src_id, edge_map, nodes) {
                            log::debug!("  Found qubit {} via node {}", qubit, src_id);
                            input_qubits.push(qubit);
                        }
                    }
                }
        ...
        // CNOT expects exactly 2 inputs
        if input_qubits.len() >= 2 {
            Some((input_qubits[0].clone(), input_qubits[1].clone()))
        } else if input_qubits.len() == 1 && self.qubit_counter >= 2 {
            // If we only found one input, use the previous qubit as the other
            let other_qubit = if input_qubits[0].ends_with("0") {
                format!("%q1")
            } else {
                format!("%q0")
            };
            Some((input_qubits[0].clone(), other_qubit))
        } else if self.qubit_counter >= 2 {
            // Fallback to the two most recent qubits
            Some((format!("%q{}", self.qubit_counter - 2), format!("%q{}", self.qubit_counter - 1)))
        } else {
            None
        }
    }
    
    fn build_qubit_dataflow(&mut self, nodes: &[serde_json::Value], edges: &[serde_json::Value]) -> Result<(), SeleneError> {
        ...
        log::debug!("Building qubit dataflow map with {} nodes and {} edges", nodes.len(), edges.len());
                ...
                if edge_array.len() >= 2 {
                    if let (Some(src_arr), Some(tgt_arr)) = (
                        ...
                        if let (Some(src_node), Some(tgt_node)) = (
                            ...
                            reverse_edges.entry(tgt_node as usize)
                                .or_insert_with(Vec::new)
                                .push((src_node as usize, tgt_port));
                                
                            forward_edges.entry(src_node as usize)
                                .or_insert_with(Vec::new)
                        ...
                        if extension == "tket.quantum" {
                            match name {
                                "QAlloc" => {
                                    ...
                                    self.qubit_dataflow.insert(node_id, qubit_var.clone());
                                    self.qubit_counter += 1;
                                    log::debug!("QAlloc node {}: assigned qubit {} for dataflow", node_id, qubit_var);
                                }
                                "H" | "X" | "Y" | "Z" | "S" | "T" | "Sdg" | "Tdg" | "Rx" | "Ry" | "Rz" => {
                                    ...
                                    if let Some(existing_qubit) = self.qubit_dataflow.get(&node_id).cloned() {
                                        log::debug!("Single-qubit gate {} (node {}) already has qubit {}", name, node_id, existing_qubit);
                                        eprintln!("DEBUG: Single-qubit gate {} (node {}) already has qubit {} - propagating to outputs", name, node_id, existing_qubit);
                                        
                                        // Propagate existing qubit to outputs
                                        if let Some(outputs) = forward_edges.get(&node_id) {
                                            for (target_node, _) in outputs {
                                                self.qubit_dataflow.insert(*target_node, existing_qubit.clone());
                                                eprintln!("DEBUG:   {} -> node {} gets existing qubit {}", name, target_node, existing_qubit);
                                            }
                                        }
                                    } else {
                                        ...
                                        if let Some(inputs) = reverse_edges.get(&node_id) {
                                            for (src_node, _port) in inputs {
                                                if let Some(qubit_var) = self.qubit_dataflow.get(src_node).cloned() {
                                                    log::debug!("Single-qubit gate {} (node {}): getting qubit {} from node {}", name, node_id, qubit_var, src_node);
                                                    eprintln!("DEBUG: Single-qubit gate {} (node {}) gets qubit {} from input node {}", name, node_id, qubit_var, src_node);
                                                    self.qubit_dataflow.insert(node_id, qubit_var.clone());
                                                    
                                                    // Also propagate to all outputs of this gate
                                                    if let Some(outputs) = forward_edges.get(&node_id) {
                                                        for (target_node, _) in outputs {
                                                            log::debug!("Single-qubit gate {} (node {}) -> node {} gets qubit {}", 
                                                                name, node_id, target_node, qubit_var);
                                                            self.qubit_dataflow.insert(*target_node, qubit_var.clone());
                                                            eprintln!("DEBUG:   {} -> node {} gets qubit {}", name, target_node, qubit_var);
                                                        }
                                                    }
                                                    break;
                                                }
                                ...
                                "CX" | "CNOT" | "CY" | "CZ" | "CH" | "CRz" => {
                                    ...
                                    eprintln!("DEBUG: === Processing two-qubit gate {} at node {} ===", name, node_id);
                                    
                                    // Collect the input qubits with their ports
                                    let mut input_qubits = Vec::new();
                                    if let Some(inputs) = reverse_edges.get(&node_id) {
                                        eprintln!("DEBUG:   {} inputs to node {}", inputs.len(), node_id);
                                        for (src_node, port) in inputs {
                                            eprintln!("DEBUG:     Input from node {} at port {}", src_node, port);
                                            if let Some(qubit_var) = self.qubit_dataflow.get(src_node).cloned() {
                                                eprintln!("DEBUG:       Found qubit {} from node {}", qubit_var, src_node);
                                    ...
                                    if !input_qubits.is_empty() {
                                        self.qubit_dataflow.insert(node_id, input_qubits[0].1.clone());
                                    }
                                    
                                    // Now propagate the appropriate qubit to each output
                                    if let Some(outputs) = forward_edges.get(&node_id) {
                                        eprintln!("DEBUG:   {} outputs from node {}", outputs.len(), node_id);
                                        for (target_node, output_port) in outputs {
                                            eprintln!("DEBUG:     Output to node {} from port {}", target_node, output_port);
                                            ...
                                            if qubit_idx < input_qubits.len() {
                                                ...
                                                self.qubit_dataflow.insert(*target_node, qubit_var.clone());
                                                log::debug!("Two-qubit gate {} (node {}) -> node {} gets qubit {}", 
                                                    name, node_id, target_node, qubit_var);
                                                eprintln!("DEBUG:       Two-qubit gate {} output port {} -> node {} gets qubit {}", 
                                                    name, output_port, target_node, qubit_var);
                                            } else {
                                                eprintln!("DEBUG:       ERROR: Output port {} exceeds input qubits ({})", 
                                                    output_port, input_qubits.len());
                                            }
                                        }
                                    }
                                    ...
                                    if let Some(outputs) = forward_edges.get(&node_id) {
                                        for (target_node, output_port) in outputs {
                                            ...
                                            if qubit_idx < input_qubits.len() {
                                                let qubit_var = input_qubits[qubit_idx].1.clone();
                                                self.qubit_dataflow.insert(*target_node, qubit_var.clone());
                                                log::debug!("Three-qubit gate {} (node {}) -> node {} gets qubit {}", 
                                                    name, node_id, target_node, qubit_var);
                                            }
                                        }
                                    }
                            ...
                            match name {
                                "MakeTuple" => {
                                    ...
                                    if let Some(inputs) = reverse_edges.get(&node_id) {
                                        let mut input_qubits = Vec::new();
                                        log::debug!("MakeTuple node {} has {} input edges", node_id, inputs.len());
                                        eprintln!("DEBUG: MakeTuple node {} has {} input edges", node_id, inputs.len());
                                        
                                        for (src_node, port) in inputs {
                                            log::debug!("  Input: src_node={}, port={}", src_node, port);
                                            eprintln!("DEBUG:   Input: src_node={}, port={}", src_node, port);
                                        ...
                                        input_qubits.sort_by_key(|(port, _)| *port);
                                        log::debug!("MakeTuple node {} sorted input qubits: {:?}", node_id, input_qubits);
                                        eprintln!("DEBUG: MakeTuple node {} sorted input qubits: {:?}", node_id, input_qubits);
                                        ...
                                        if !input_qubits.is_empty() {
                                            ...
                                            self.qubit_dataflow.insert(node_id, input_qubits[0].1.clone());
                                            log::debug!("MakeTuple node {}: stored qubit {} in dataflow", node_id, input_qubits[0].1);
                                            eprintln!("DEBUG: MakeTuple node {}: stored qubit {} in dataflow", node_id, input_qubits[0].1);
                                        }
                                    } else {
                                        log::debug!("MakeTuple node {} has no input edges", node_id);
                                        eprintln!("DEBUG: MakeTuple node {} has no input edges", node_id);
                                    }
                                ...
                                "UnpackTuple" => {
                                    ...
                                    if let Some(inputs) = reverse_edges.get(&node_id) {
                                        log::debug!("UnpackTuple node {} has {} input edges", node_id, inputs.len());
                                        eprintln!("DEBUG: UnpackTuple node {} has {} input edges", node_id, inputs.len());
                                        
                                        // Find the tuple source
                                        for (src_node, input_port) in inputs {
                                            log::debug!("  Checking input: src_node={}, port={}", src_node, input_port);
                                            eprintln!("DEBUG:   Checking input: src_node={}, port={}", src_node, input_port);
                                            
                                            // Check if the source is a MakeTuple
                                            if let Some(src_node_data) = nodes.get(*src_node) {
                                                if let (Some(src_ext), Some(src_name)) = (
                                                    src_node_data.get("extension").and_then(|e| e.as_str()),
                                                    src_node_data.get("name").and_then(|n| n.as_str())
                                                ) {
                                                    log::debug!("    Source node {} is {}.{}", src_node, src_ext, src_name);
                                                    eprintln!("DEBUG:     Source node {} is {}.{}", src_node, src_ext, src_name);
                                                    
                                                    if src_ext == "prelude" && src_name == "MakeTuple" {
                                                        log::debug!("    Found MakeTuple source at node {}", src_node);
                                                        eprintln!("DEBUG:     Found MakeTuple source at node {}", src_node);
                                                        
                                                        // Get the original qubits that went into the tuple
                                                        if let Some(tuple_inputs) = reverse_edges.get(src_node) {
                                                            let mut original_qubits = Vec::new();
                                                            log::debug!("    MakeTuple node {} has {} inputs", src_node, tuple_inputs.len());
                                                            eprintln!("DEBUG:     MakeTuple node {} has {} inputs", src_node, tuple_inputs.len());
                                                            
                                                            for (orig_src, orig_port) in tuple_inputs {
                                                                log::debug!("      MakeTuple input: src_node={}, port={}", orig_src, orig_port);
                                                                eprintln!("DEBUG:       MakeTuple input: src_node={}, port={}", orig_src, orig_port);
                                                                
                                                                if let Some(qubit_var) = self.qubit_dataflow.get(orig_src).cloned() {
                                                                    log::debug!("        Found qubit: {}", qubit_var);
                                                                    eprintln!("DEBUG:         Found qubit: {}", qubit_var);
                                                                    original_qubits.push((*orig_port, qubit_var.clone()));
                                                                } else {
                                                                    log::debug!("        No qubit found for node {}", orig_src);
                                                                    eprintln!("DEBUG:         No qubit found for node {}", orig_src);
                                                                }
                                                            }
                                                            original_qubits.sort_by_key(|(port, _)| *port);
                                                            log::debug!("    Original qubits from MakeTuple (sorted): {:?}", original_qubits);
                                                            eprintln!("DEBUG:     Original qubits from MakeTuple (sorted): {:?}", original_qubits);
                                                            ...
                                                            if !original_qubits.is_empty() {
                                                                ...
                                                                self.qubit_dataflow.insert(node_id, original_qubits[0].1.clone());
                                                                log::debug!("    Stored qubit {} for UnpackTuple node {}", original_qubits[0].1, node_id);
                                                                eprintln!("DEBUG:     Stored qubit {} for UnpackTuple node {}", original_qubits[0].1, node_id);
                                                                
                                                                // Store metadata about all qubits from the tuple
                                                                self.unpack_tuple_outputs.insert(node_id, original_qubits.clone());
                                                                log::debug!("    UnpackTuple node {} has {} qubits available in unpack_tuple_outputs", 
                                                                    node_id, original_qubits.len());
                                                                eprintln!("DEBUG:     UnpackTuple node {} has {} qubits available in unpack_tuple_outputs", 
                                                                    node_id, original_qubits.len());
                                                            }
                                                            
                                                            // Now propagate to UnpackTuple outputs
                                                            if let Some(outputs) = forward_edges.get(&node_id) {
                                                                log::debug!("    UnpackTuple node {} has {} output edges", node_id, outputs.len());
                                                                eprintln!("DEBUG:     UnpackTuple node {} has {} output edges", node_id, outputs.len());
                                                                
                                                                for (target_node, output_port) in outputs {
                                                                    let idx = *output_port as usize;
                                                                    log::debug!("      Output: target_node={}, port={} (idx={})", target_node, output_port, idx);
                                                                    eprintln!("DEBUG:       Output: target_node={}, port={} (idx={})", target_node, output_port, idx);
                                                                    
                                                                    if idx < original_qubits.len() {
                                                                        let qubit_var = original_qubits[idx].1.clone();
                                                                        self.qubit_dataflow.insert(*target_node, qubit_var.clone());
                                                                        log::debug!("        UnpackTuple node {} -> node {} gets qubit {} (from port {})", 
                                                                            node_id, target_node, qubit_var, output_port);
                                                                        eprintln!("DEBUG:         UnpackTuple node {} -> node {} gets qubit {} (from port {})", 
                                                                            node_id, target_node, qubit_var, output_port);
                                                                    } else {
                                                                        log::warn!("        Output port {} exceeds available qubits ({})", output_port, original_qubits.len());
                                                                        eprintln!("DEBUG:         WARNING: Output port {} exceeds available qubits ({})", output_port, original_qubits.len());
                                                                    }
                                                                }
                                                            } else {
                                                                log::debug!("    UnpackTuple node {} has no output edges", node_id);
                                                                eprintln!("DEBUG:     UnpackTuple node {} has no output edges", node_id);
                                                            }
                                                        } else {
                                                            log::debug!("    MakeTuple node {} has no inputs", src_node);
                                                            eprintln!("DEBUG:     MakeTuple node {} has no inputs", src_node);
                                                        }
                                                    }
                                                } else {
                                                    log::debug!("    Source node {} is not a MakeTuple", src_node);
                                                    eprintln!("DEBUG:     Source node {} is not a MakeTuple", src_node);
                                                }
                                            } else {
                                                log::debug!("    No data found for source node {}", src_node);
                                                eprintln!("DEBUG:     No data found for source node {}", src_node);
                                            }
                                        }
                                    } else {
                                        log::debug!("UnpackTuple node {} has no input edges", node_id);
                                        eprintln!("DEBUG: UnpackTuple node {} has no input edges", node_id);
                                    }
        ...
        eprintln!("DEBUG: Final unpack_tuple_outputs: {:?}", self.unpack_tuple_outputs);
        Ok(())
    }
