...
pub fn generate_quantum_llvm_ir(
    module_name: &str,
    entry_point: &str,
) -> Result<String> {
    ...
    writeln!(&mut llvm_ir, "  %q0 = call %Qubit* @__quantum__qis__qalloc()")?;
    writeln!(&mut llvm_ir, "  %q1 = call %Qubit* @__quantum__qis__qalloc()")?;
    writeln!(&mut llvm_ir)?;
    
    writeln!(&mut llvm_ir, "  ; Apply gates")?;
    writeln!(&mut llvm_ir, "  call void @__quantum__qis__h__body(%Qubit* %q0)")?;
    writeln!(&mut llvm_ir, "  call void @__quantum__qis__cnot__body(%Qubit* %q0, %Qubit* %q1)")?;
    writeln!(&mut llvm_ir)?;
    
    writeln!(&mut llvm_ir, "  ; Measure")?;
    writeln!(&mut llvm_ir, "  %r0 = call %Result* @__quantum__qis__mz__body(%Qubit* %q0)")?;
    writeln!(&mut llvm_ir, "  %r1 = call %Result* @__quantum__qis__mz__body(%Qubit* %q1)")?;
    writeln!(&mut llvm_ir)?;
    
    writeln!(&mut llvm_ir, "  ; Free qubits")?;
    writeln!(&mut llvm_ir, "  call void @__quantum__qis__qfree(%Qubit* %q0)")?;
    writeln!(&mut llvm_ir, "  call void @__quantum__qis__qfree(%Qubit* %q1)")?;
    writeln!(&mut llvm_ir)?;
...
fn append_qis_declarations(llvm_ir: &mut String) -> Result<()> {
    ...
    // Rotation gates
    writeln!(llvm_ir, "declare void @__quantum__qis__rx__body(double, %Qubit*)")?;
    writeln!(llvm_ir, "declare void @__quantum__qis__ry__body(double, %Qubit*)")?;
    writeln!(llvm_ir, "declare void @__quantum__qis__rz__body(double, %Qubit*)")?;
    
    // Two-qubit gates
    writeln!(llvm_ir, "declare void @__quantum__qis__cnot__body(%Qubit*, %Qubit*)")?;
    writeln!(llvm_ir, "declare void @__quantum__qis__cz__body(%Qubit*, %Qubit*)")?;
    
    // Measurement
    writeln!(llvm_ir, "declare %Result* @__quantum__qis__mz__body(%Qubit*)")?;
    writeln!(llvm_ir, "declare %Result* @__quantum__qis__mx__body(%Qubit*)")?;
    writeln!(llvm_ir, "declare %Result* @__quantum__qis__my__body(%Qubit*)")?;
    writeln!(llvm_ir, "declare void @__quantum__qis__reset__body(%Qubit*)")?;
    
    // Result operations
    writeln!(llvm_ir, "declare i1 @__quantum__qis__read_result__body(%Result*)")?;
