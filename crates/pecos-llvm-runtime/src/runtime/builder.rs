...
//!
//! This module handles building and managing the static pecos-llvm-runtime runtime library
//! that LLVM IR programs link against.
//!
//! # Runtime Library Location
//!
//! The static library is stored at:
//! - Linux/macOS: `~/.cargo/pecos-llvm-runtime/libpecos_llvm_runtime.a`
//! - Windows: `~/.cargo/pecos-llvm-runtime/pecos_llvm_runtime.lib`
//!
//! # Rebuild Strategy
//!
...
//! 2. **Marker File**: If `~/.cargo/pecos-llvm-runtime/.needs_rebuild` exists
//!
//! The marker file is created by the build.rs script when it detects:
//! - Source files in pecos-llvm-runtime have changed
...
//!
//! The build process:
//! 1. Creates a minimal wrapper crate that depends on pecos-llvm-runtime
...
/// Handles building the static pecos-llvm-runtime runtime library
...
impl RuntimeBuilder {
    ...
    /// - The library file doesn't exist at `~/.cargo/pecos-llvm-runtime/libpecos_llvm_runtime.a`
    /// - The marker file `~/.cargo/pecos-llvm-runtime/.needs_rebuild` exists
    ///
    ...
    fn build_static_library(lib_path: &Path) -> Result<(), PecosError> {
        ...
        // The library will be in target/release/libpecos_llvm_runtime.a (or .lib on Windows)
    ...
    fn create_wrapper_crate(build_dir: &Path) -> Result<(), PecosError> {
        ...
        let cargo_toml = format!(
            r#"[package]
name = "pecos-llvm-runtime-static"
version = "{version}"
edition = "{edition}"

[lib]
name = "pecos_llvm_runtime"
crate-type = ["staticlib"]

[dependencies]
pecos-llvm-runtime = {{ path = {:?} }}
"#,
...
pub use pecos_llvm_runtime::runtime::*;
pub use pecos_llvm_runtime::runtime::state::*;
pub use pecos_llvm_runtime::runtime::registry::*;
";
