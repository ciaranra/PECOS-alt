...
use pecos_phir::attributes::{AttributeBuilder, helpers};
use pecos_phir::builtin_ops::{BuiltinOp, FuncOp};
use pecos_phir::ops::Operation;
use pecos_phir::phir::{AttributeValue, Module, Region};
use pecos_phir::region_kinds::RegionKind;
    ...
    let mut qft_func = FuncOp::new(
        ...
        FunctionType {
            inputs: vec![Type::Array(
                Box::new(Type::Qubit),
                pecos_phir::types::ArraySize::Fixed(16),
            )],
