//! Test HUGR 0.13 support in pecos-selene-engine

#[cfg(feature = "hugr-013")]
#[test]
fn test_hugr_013_in_selene() {
    use pecos_selene_engine::hugr_013_support;
...
fn test_hugr_version_info() {
    println!("pecos-selene-engine uses HUGR 0.13 for guppylang compatibility");
