...
///
/// This module is primarily used internally by `QisEngine`, but is exposed
...
///
/// Most users should use `QisEngine` instead of interacting with the linker directly.
pub mod linker;
...
/// with LLVM IR programs. Most users should use `QisEngine` instead of
