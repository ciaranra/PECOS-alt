//! Prelude module for pecos-qis-runtime
//!
...
//!     let engine = QisEngine::new(PathBuf::from("program.ll"));
//!
...
//!     // managing temporary files, etc.), consider using the `pecos-qis-sim` crate
