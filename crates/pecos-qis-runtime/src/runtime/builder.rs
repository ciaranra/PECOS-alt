...
//!
//! This module handles building and managing the static pecos-qis-runtime runtime library
//! that LLVM IR programs link against.
//!
//! # Runtime Library Location
//!
//! The static library is stored at:
//! - Linux/macOS: `~/.cargo/pecos-qis-runtime/libpecos_qis_runtime.a`
//! - Windows: `~/.cargo/pecos-qis-runtime/pecos_qis_runtime.lib`
//!
//! # Rebuild Strategy
//!
...
//! 2. **Marker File**: If `~/.cargo/pecos-qis-runtime/.needs_rebuild` exists
//!
//! The marker file is created by the build.rs script when it detects:
//! - Source files in pecos-qis-runtime have changed
...
//!
//! The build process:
//! 1. Creates a minimal wrapper crate that depends on pecos-qis-runtime
...
/// Handles building the static pecos-qis-runtime runtime library
...
impl RuntimeBuilder {
    ...
    /// - The library file doesn't exist at `~/.cargo/pecos-qis-runtime/libpecos_qis_runtime.a`
    /// - The marker file `~/.cargo/pecos-qis-runtime/.needs_rebuild` exists
    ///
    ...
    fn build_static_library(lib_path: &Path) -> Result<(), PecosError> {
        ...
        // The library will be in target/release/libpecos_qis_runtime.a (or .lib on Windows)
    ...
    fn create_wrapper_crate(build_dir: &Path) -> Result<(), PecosError> {
        ...
        let cargo_toml = format!(
            r#"[package]
name = "pecos-qis-runtime-static"
version = "{version}"
edition = "{edition}"

[lib]
name = "pecos_qis_runtime"
crate-type = ["staticlib"]

[dependencies]
pecos-qis-runtime = {{ path = {:?} }}
"#,
...
pub use pecos_qis_runtime::runtime::*;
pub use pecos_qis_runtime::runtime::state::*;
pub use pecos_qis_runtime::runtime::registry::*;
";
